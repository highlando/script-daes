...
kable(data.frame(Problem = c("nonlinear", "linear TV", "linear CC"),
  	  ...
  	  booktabs = T,
	  escape = F,
	  caption = "Overview of convergence results of BDF/RKM schemes for DAEs of various index and, possibly, semi-explicit structure. Here, we equate \\emph{index-1} and \\emph{strangeness-free}. A $\\cdot$ indicates that this case is included in a result for a more general case \\emph{located} left or above in the table.",
...
| DAEs | Resources |
|:------------|:------------------------|
| Navier-Stokes (nl-se-$2$) | See, e.g., Sec. 4.3 of our [preprint](http://www.janheiland.de/files/ah18-nsedaef.pdf) on definitions of different schemes |
