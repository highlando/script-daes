...
\begin{equation}
0< \gamma_1 <\gamma_2< \dotsc < \gamma_s=1 (\#eq:rkm-collo-gamma)
\end{equation}
 ...
 * convergence of these schemes applied to \@ref(eq:impl-sf-dae-fone)--\@ref(eq:impl-sf-dae-fone) is proven in Kunkel/Mehrmann Theorem 5.17
